...
razvoj softvera za automobile. \v{S}iroka upotreba ovih standarda izrodila je potrebu za alatima za stati\v{c}ku analizu koji bi automatizovali proces provere da li je kod napisan u skladu sa standardom. Kompajlerska infrastruktura LLVM pru\v{z}a podr\v{s}ku za jednostavno razvijanje kvalitetnih alata ovog tipa. Cilj ovog rada je izrada alata
za stati\v{c}ku analizu koji proverava da li je kod napisan u skladu sa podskupom pravila koja se odnose na deklaracije u okviru standarda \textsc{autosar} C++14. Alat treba ispisivati upozorenja za delove koda koji nisu u skladu sa nekim od pravila i predlagati izmene tog koda. Ideja za ostvarivanje ovog cilja je da se iskoriste biblioteke
kompajlerske infrastrukture LLVM koji omogu\'{c}avaju analizu informacija o izvornom kodu koje se mogu dobiti tokom kompilacije programa.
}
\usepackage{tcolorbox}
% Ključne reči na srpskom jeziku (u odabranom pismu)
\kljucnereci{\textsc{autosar}, Clang, LLVM, C++, stati\v{c}ka analiza}
