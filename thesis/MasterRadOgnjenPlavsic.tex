...
Svi alati zasnovani na kompajleru \textit{Clang} zahtevaju kompilacionu bazu podataka (eng.~\textit{compilation database}) kako bi zaklju\v{c}ili koje opcije treba koristiti prilikom prevođenja fajla nad kojim se pokre\'{c}e alat. Informacije o opcijama koje se koriste prilikom proveđenja fajla mogu biti krucijalne za pokretanje alata nad tim fajlom. Na primer, ukoliko fajl nad kojim je pokrenut alat uklju\v{c}uje heder fajlove koji nisu sistemski, neophodno je navesti putanju do tih heder fajlova ina\v{c}e kompajler \textit{Clang} ne\'{c}e mo\'{c}i da izgradi apstraktno sintaksno stablo, a samim tim \'{c}e se prekinuti i izvr\v{s}avanje alata.
\par
