...
Mogu\'{c}e opcije su:
  \begin{description}
    ...
    \texttt{auto-hint ./AutoFixTest.cpp --rules="A7\_2\_3, A7\_1\_6"} \\
...
Testovi \texttt{auto-hint-A7-1-6\-.cpp}, \texttt{auto-hint-A7-2-3.cpp}, \texttt{auto-hint-A8-5-2.cpp} i \texttt{auto-hint-A8-5-3.cpp} nalaze se u okviru direktorijuma \texttt{autofix-test} i redom testiraju implementaciju pravila
