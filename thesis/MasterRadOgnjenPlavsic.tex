...
\\
\begin{lstlisting}[caption={Primer implementacije jednostavnog alata upotrebom interfejsa \lstinline{ASTVisitor}, \lstinline{ASTConsumer}, \lstinline{FrontendAction} i bibliotekom \lstinline{libtooling} \cite{ASTToolTutorial}}, label=lst:label9, captionpos=b]
