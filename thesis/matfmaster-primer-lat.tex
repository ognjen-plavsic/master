...
\begin{enumerate}
  ...
  \item{\textbf{AST biblioteka} \\
        Ova biblioteka implementira algoritme i strukture podataka koje parser koristi za izgradnju AST-a. Specifična je po strukturi čvorova koji podsećaju na pisani C++ kod što je čini pogodnim za kreiranje alata za refaktorisanje koda i statičku analizu.}
  \item{\textbf{Sema} \\
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\textwidth]{ClangBiblioteke.png}
